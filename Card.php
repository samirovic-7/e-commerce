...
<?php include"./fixed_temp/header.php" ?>
        ...
        <div class="Card_body">
            ...
            <div class="card_left col-md-6 col-sm-11"></div>
            <div class="card_right col-md-6 col-sm-11">
                <div class="card_right_top col-md-11 col-sm-11">
                    <button class="btn btn-primary button_add" type="button"><a href="#">Add Card</a></button>
                    <div class="heart_fav"><i class="bi bi-heart-fill"></i> </div>

                    <button class="btn btn-primary button_buy" type="button"><a href="#">Buy Now</a></button>
                </div>

                <div class="card_right_bottom col-md-11 col-sm-11">
