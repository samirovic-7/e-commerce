    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <form class="row g-3 form" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-md-6 inplab ">
                ...
                <input type="text " class="form-control input " id="inputPhone " name="vedio_name">
            </div>
            ...
            <div class="col-md-6 inplab ">
              ...
              <?php
                ...
                foreach ($sql as $key) {
                    ...
                    $type_id = $key["vedio_game_type_id"];
                    echo"
            ...
            <div class="col-md-12 inplab ">
                ...
                <input type="text " class="form-control input " id="inputPhone " name="vedio_title">
            </div>

            <div class="col-md-6 inplab ">
                <label for="inputPhone " class="form-label ">Price of product</label>
                <input type="number " class="form-control input " id="inputPhone" name="vedio_price">
            </div>

            <div class="col-md-6 inplab ">
                <label for="inputPhone " class="form-label ">Rate of product</label>
                <input type="number " class="form-control input " id="inputPhone" name="vedio_rate">
            </div>
...
if(isset($_POST['insert'])){
    ...
    $name = $_POST['vedio_name'];
    $title = $_POST['vedio_title'];
    $price = $_POST['vedio_price'];
    $rate = $_POST['vedio_rate'];
    $type = $_POST['type_id'];
    
    $image = $_FILES['image']['name'];
    $image_tmp = $_FILES['image']['tmp_name'];
    move_uploaded_file($image_tmp,"../img/vediogame/$image");

    $sql=$database->prepare("INSERT INTO vedio_game(vedio_game_name,vedio_game_title,vedio_game_price,vedio_game_rate,vedio_game_type,vedio_game_image) VALUES(:name,:title,:price,:rate,:type,:img)");
