    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <form class="row g-3 form" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-md-6 inplab ">
                ...
                <input type="text " class="form-control input " id="inputPhone " name="table_name">
            </div>
            ...
            <div class="col-md-6 inplab ">
              ...
              <?php
                $sql = $database->prepare("SELECT * FROM table_type");
                $sql->execute();
                foreach ($sql as $key) {
                    $name = $key["Table_type_name"];
                    $type_id = $key["Table_type_id"];
                    echo"
            ...
            <div class="col-md-12 inplab ">
                ...
                <input type="text " class="form-control input " id="inputPhone " name="table_title">
            </div>

            <div class="col-md-6 inplab ">
                <label for="inputPhone " class="form-label ">Price of product</label>
                <input type="number " class="form-control input " id="inputPhone" name="table_price">
            </div>

            <div class="col-md-6 inplab ">
                <label for="inputPhone " class="form-label ">Rate of product</label>
                <input type="number " class="form-control input " id="inputPhone" name="table_rate">
            </div>
...
if(isset($_POST['insert'])){
    ...
    $rate = $_POST['table_rate'];
    $type = $_POST['type_id'];
    
    $image = $_FILES['image']['name'];
    $image_tmp = $_FILES['image']['tmp_name'];
    move_uploaded_file($image_tmp,"../img/table/$image");

    $sql=$database->prepare("INSERT INTO tables(Table_name,Table_title,Table_price,Table_rate,type_id,Table_image) VALUES(:name,:title,:price,:rate,:type,:img)");
