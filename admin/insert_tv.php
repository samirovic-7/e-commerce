    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <form class="row g-3 form" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-md-6 inplab ">
                ...
                <input type="text " class="form-control input " id="inputPhone " name="tv_name">
            </div>
            ...
            <div class="col-md-6 inplab ">
              ...
              <?php
                $sql = $database->prepare("SELECT * FROM tv_type");
                $sql->execute();
                foreach ($sql as $key) {
                    $name = $key["T.V_type_name"];
                    $type_id = $key["TV_type_id"];
                    echo"
            ...
            <div class="col-md-6 inplab ">
                ...
                <select class="form-select input " aria-label="Default select example "  name="size_id">
              <option hidden>Select Product</option>
              <?php
                $sql = $database->prepare("SELECT * FROM tv_size");
                $sql->execute();
                foreach ($sql as $key) {
                    $name = $key["T.V_size_name"];
                    $size_id = $key["T.V_size_id"];
                    echo"
            ...
            <div class="col-md-12 inplab ">
                ...
                <input type="text " class="form-control input " id="inputPhone " name="tv_title">
            </div>

            <div class="col-md-6 inplab ">
                <label for="inputPhone " class="form-label ">Price of product</label>
                <input type="number " class="form-control input " id="inputPhone" name="tv_price">
            </div>

            <div class="col-md-6 inplab ">
                <label for="inputPhone " class="form-label ">Rate of product</label>
                <input type="number " class="form-control input " id="inputPhone" name="tv_rate">
            </div>
...
if(isset($_POST['insert'])){
    ...
    move_uploaded_file($image_tmp,"../img/tv/$image");

    $sql=$database->prepare("INSERT INTO tv(tv_name,tv_title,tv_price,tv_rate,tv_type,tv_size,tv_image) VALUES(:name,:title,:price,:rate,:type,:size,:img)");
