    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <form class="row g-3 form" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-md-6 inplab ">
                ...
                <input type="text " class="form-control input " id="inputPhone " name="wireless_device_name">
            </div>
            ...
            <div class="col-md-12 inplab ">
                ...
                <input type="text " class="form-control input " id="inputPhone " name="wireless_device_title">
            </div>

            <div class="col-md-6 inplab ">
                <label for="inputPhone " class="form-label ">Price of product</label>
                <input type="number " class="form-control input " id="inputPhone" name="wireless_device_price">
            </div>

            <div class="col-md-6 inplab ">
                <label for="inputPhone " class="form-label ">Rate of product</label>
                <input type="number " class="form-control input " id="inputPhone" name="wireless_device_rate">
            </div>
...
if(isset($_POST['insert'])){
    ...
    $name = $_POST['wireless_device_name'];
    $title = $_POST['wireless_device_title'];
    $price = $_POST['wireless_device_price'];
    $rate = $_POST['wireless_device_rate'];
    $type = $_POST['type_id'];
    
    $image = $_FILES['image']['name'];
    $image_tmp = $_FILES['image']['tmp_name'];
    move_uploaded_file($image_tmp,"../img/Wirelessdevices/$image");

    $sql=$database->prepare("INSERT INTO wireless_device(Wireless_device_name,Wireless_device_title,Wireless_device_price,Wireless_device_rate,Wireless__type_device_id,Wireless_device_image) VALUES(:name,:title,:price,:rate,:type,:img)");
