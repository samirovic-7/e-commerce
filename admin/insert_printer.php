    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <form class="row g-3 form" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-md-6 inplab ">
                ...
                <input type="text " class="form-control input " id="inputPhone " name="Printer_name">
            </div>
            ...
            <div class="col-md-6 inplab ">
              ...
              <?php
                $sql = $database->prepare("SELECT * FROM printer_type");
                $sql->execute();
                foreach ($sql as $key) {
                    $name = $key["Printer_type_name"];
                    $type_id = $key["Printer_type_id"];
                    echo"
            ...
            <div class="col-md-12 inplab ">
                ...
                <input type="text " class="form-control input " id="inputPhone " name="Printer_title">
            </div>

            <div class="col-md-6 inplab ">
                <label for="inputPhone " class="form-label ">Price of product</label>
                <input type="number " class="form-control input " id="inputPhone" name="Printer_price">
            </div>

            <div class="col-md-6 inplab ">
                <label for="inputPhone " class="form-label ">Rate of product</label>
                <input type="number " class="form-control input " id="inputPhone" name="Printer_rate">
            </div>
...
if(isset($_POST['insert'])){
    ...
    $title = $_POST['Printer_title'];
    $price = $_POST['Printer_price'];
    $rate = $_POST['Printer_rate'];
    $type = $_POST['type_id'];
    
    $image = $_FILES['image']['name'];
    $image_tmp = $_FILES['image']['tmp_name'];
    move_uploaded_file($image_tmp,"../img/printer/$image");

    $sql=$database->prepare("INSERT INTO printer(Printer_name,Printer_title,Printer_price,Printer_rate,Printer_type,Printer_image) VALUES(:name,:title,:price,:rate,:type,:img)");
