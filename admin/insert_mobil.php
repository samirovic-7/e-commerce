    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <form class="row g-3 form" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-md-6 inplab ">
                ...
                <input type="text " class="form-control input " id="inputPhone " name="mobile_name">
            </div>


            <div class="col-md-6 inplab ">
                <label for="inputselect " class="form-label ">The Type Of This mobile</label>
            ...
            <div class="col-md-6 inplab ">
                <label for="inputselect " class="form-label ">The stroge Of This mobile</label>

                <select class="form-select input " aria-label="Default select example "  name="storage_id">
              <option hidden>Select Product</option>
              <?php
            ...
            <div class="col-md-6 inplab ">
                <label for="inputselect " class="form-label ">The color Of This mobile</label>
            ...
            <div class="col-md-12 inplab ">
                ...
                <input type="text " class="form-control input " id="inputPhone " name="mobile_title">
            </div>

            <div class="col-md-6 inplab ">
                <label for="inputPhone " class="form-label ">Price of product</label>
                <input type="number " class="form-control input " id="inputPhone" name="mobile_price">
            </div>

            <div class="col-md-6 inplab ">
                <label for="inputPhone " class="form-label ">Rate of product</label>
                <input type="number " class="form-control input " id="inputPhone" name="mobile_rate">
            </div>
...
if(isset($_POST['insert'])){
    ...
    $title = $_POST['mobile_title'];
    $price = $_POST['mobile_price'];
    $rate = $_POST['mobile_rate'];
    $type = $_POST['type_id'];
    ...
    move_uploaded_file($image_tmp,"../img/mobile/$image");

    $sql=$database->prepare("INSERT INTO mobile(mobile_name,mobile_title,mobile_price,mobile_rate,type_id,storage_id,color_id,mobile_image) VALUES(:name,:title,:price,:rate,:type,:sto,:color,:img)");
