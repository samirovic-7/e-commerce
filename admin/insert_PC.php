    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <form class="row g-3 form" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-md-6 inplab ">
                ...
                <input type="text " class="form-control input " id="inputPhone " name="pc_name">
            </div>
            ...
            <div class="col-md-6 inplab ">
              ...
              <?php
                $sql = $database->prepare("SELECT * FROM pc_type");
                $sql->execute();
                foreach ($sql as $key) {
                    $name = $key["pc_type_name"];
                    $type_id = $key["pc_type_id"];
                    echo"
            ...
            <div class="col-md-12 inplab ">
                ...
                <input type="text " class="form-control input " id="inputPhone " name="pc_title">
            </div>

            <div class="col-md-6 inplab ">
                <label for="inputPhone " class="form-label ">Price of product</label>
                <input type="number " class="form-control input " id="inputPhone" name="pc_price">
            </div>

            <div class="col-md-6 inplab ">
                <label for="inputPhone " class="form-label ">Rate of product</label>
                <input type="number " class="form-control input " id="inputPhone" name="pc_rate">
            </div>
...
if(isset($_POST['insert'])){
    ...
    $name = $_POST['pc_name'];
    $title = $_POST['pc_title'];
    $price = $_POST['pc_price'];
    $rate = $_POST['pc_rate'];
    $type = $_POST['type_id'];
    
    $image = $_FILES['image']['name'];
    $image_tmp = $_FILES['image']['tmp_name'];
    move_uploaded_file($image_tmp,"../img/PC/$image");

    $sql=$database->prepare("INSERT INTO pc(pc_name,pc_title,pc_price,pc_rate,pc_type_id,pc_image) VALUES(:name,:title,:price,:rate,:type,:img)");
